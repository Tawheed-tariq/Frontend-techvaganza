  ...
  return (
    <footer className="bg-primary bg-opacity-20 text-white py-8 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-secondary my-6 mx-auto w-full max-w-screen-lg" /> {/* Solid line spanning full width */}
        <div className="w-full text-center py-6">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
              <img src="path_to_linkedin_image" alt="LinkedIn" className="w-8 h-8"/>
            </a>
