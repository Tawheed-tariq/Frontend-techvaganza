...
const Footer = () => {
  return (
    <footer className="bg-primary bg-opacity-20 text-white py-6 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="mx-auto w-full max-w-screen-xl px-2 sm:px-2"> {/* Adjusted to 2px padding */}
        ...
        <div className="border-t border-secondary my-2 sm:my-4"></div> {/* Adjusted margin */}
        <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start">
          ...
          <div className="flex space-x-2 sm:space-x-4"> {/* Adjusted spacing */}
