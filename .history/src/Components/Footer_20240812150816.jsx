    ...
    <footer className="bg-primary bg-opacity-20 text-white py-8 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="flex flex-col md:flex-row">
              <ul className="text-sm flex-1 font-playfair mb-4 md:mb-0">
              ...
              <ul className="text-sm flex-1 ml-0 md:ml-10">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center">
          <p className="text-lg font-playfair mb-4 md:mb-0">© Techvaganza 2024, all rights reserved.</p>
