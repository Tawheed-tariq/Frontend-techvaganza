...
const Footer = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="text-2xl font-playfair text-secondary font-extrabold mb-6 break-words">Where Innovation Meets <br/Sustainability</p>
          </div>
  ...
  <ul className="text-sm flex-1 font-playfair sm:ml-0 space-y-4 md:space-y-0">
    ...
    <li><Link to="/" className="text-secondary hover:underline">Singing</Link></li>
          ...
          <div className="w-1/4 md:w-1/3 mb-6 md:mb-0">
