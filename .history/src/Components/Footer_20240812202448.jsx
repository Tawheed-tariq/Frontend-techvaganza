  ...
  return (
    <footer className="bg-primary bg-opacity-20 text-white py-6 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-4 md:mb-0">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-4">
              <ul className="text-sm flex-1 font-playfair space-y-2 sm:space-y-3">
          ...
          <div className="w-full md:w-1/3 mb-4 md:mb-0">
            ...
            <div className="relative w-full h-36 sm:h-48 mt-2 rounded-lg overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center sm:justify-items-start">
