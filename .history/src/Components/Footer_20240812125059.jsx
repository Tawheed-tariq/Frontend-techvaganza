...
const Footer = () => {
  return (
    <footer className="bg-primary bg-opacity-75 text-white py-8 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h2 className="text-3xl font-playfair">Techraganza 2024</h2>
            <p className="text-lg">Where Innovation Meets Sustainability</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
        ...
        <div className="mt-8 text-center">
          <p className="text-lg">© Techraganza 2024, all rights reserved.</p>
        </div>
      </div>
    </footer>
  );
