    ...
    <footer className="bg-primary bg-opacity-20 text-white py-8 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <div className="flex flex-wrap md:flex-row md:space-x-10 mb-4">
              <div className="flex flex-row justify-center space-x-4 mb-4 md:mb-0">
              ...
              <ul className="text-sm font-playfair flex-1 flex flex-col space-y-1">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="relative w-full h-32 mt-4 rounded-lg overflow-hidden md:h-48">
