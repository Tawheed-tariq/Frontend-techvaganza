      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="my-6 border-t border-secondary" /> {/* Solid line */}
            <div className="w-full">
              <h3 className="text-2xl font-playfair text-primary mb-2">Follow Us</h3>
              <div className="flex space-x-4">
                <a href="https://www.instagram.com"><img src="path_to_instagram_image" alt="Instagram" className="w-8 h-8"/></a>
                <a href="https://www.facebook.com"><img src="path_to_facebook_image" alt="Facebook" className="w-8 h-8"/></a>
                <a href="https://www.linkedin.com"><img src="path_to_linkedin_image" alt="LinkedIn" className="w-8 h-8"/></a>
                <a href="https://www.twitter.com"><img src="path_to_twitter_image" alt="Twitter" className="w-8 h-8"/></a>
              </div>
            </div>
          </div>
        </div>
