...
const Footer = () => {
  ...
  <ul className="text-sm flex-1 font-playfair mb-4 sm:mb-0 sm:mr-10">
    ...
    <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Wnorkshops</Link></li>
  ...
  <ul className="text-sm flex-1 font-playfair sm:ml-10">
