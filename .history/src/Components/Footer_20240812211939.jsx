...
const Footer = () => {
  return (
    <footer className="bg-primary bg-opacity-20 text-white py-6 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="mx-auto w-full max-w-screen-xl px-2 sm:px-4"> {/* Adjusted padding */}
        <div className="flex flex-wrap justify-between items-start"> {/* Added items-start */}
          <div className="w-full md:w-1/3 mb-4 md:mb-0">
            <h2 className="text-3xl sm:text-4xl font-playfair text-primary font-extrabold mb-4">Techvaganza 2024</h2>
            <p className="text-xl sm:text-2xl font-playfair text-secondary font-extrabold mb-4">Where Innovation Meets Sustainability</p>
          </div>
          ...
          <div className="w-1/4 sm:w-1/2 md:w-1/3 mb-4 md:mb-0">
        ...
        <div className="border-t border-secondary my-4 sm:my-6"></div> {/* Solid line spanning full width */}
