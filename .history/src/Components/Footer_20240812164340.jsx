...
const Footer = () => {
  return (
    <footer className="bg-primary bg-opacity-20 text-white py-8 font-averia fixed bottom-0 left-0 w-full z-10 overflow-x-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-2 md:gap-8">
              <ul className="text-sm flex-1 font-playfair mb-4 sm:mb-0 space-y-4 sm:space-y-2">
              ...
              <ul className="text-sm flex-1 font-playfair sm:ml-2 space-y-4 sm:space-y-2">
