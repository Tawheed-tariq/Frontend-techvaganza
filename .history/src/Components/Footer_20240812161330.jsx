...
<div className="w-full md:w-1/3 mb-6 md:mb-0 sm:w-1/3">
  <h3 className="text-2xl text-primary font-playfair">Location</h3>
  <div className="relative w-full h-48 mt-4 rounded-lg overflow-hidden sm:h-36 sm:w-1/5">
    <MapContainer
      center={[34.083656, 74.797372]}
      zoom={13}
