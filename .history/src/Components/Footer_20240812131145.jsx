    ...
    <footer className="bg-primary bg-opacity-20 text-white py-8 font-averia fixed bottom-0 left-0 w-full z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-2xl font-playfair text-pr">Exciting Activities</h3>
            <ul className="text-lg">
  <li><Link to="/" className="text-primary hover:underline">Hackathons</Link></li>
  <li><Link to="/" className="text-primary hover:underline">Project Showcase</Link></li>
  <li><Link to="/" className="text-primary hover:underline">Workshops</Link></li>
  <li><Link to="/" className="text-primary hover:underline">Tech Talks</Link></li>
</ul>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
