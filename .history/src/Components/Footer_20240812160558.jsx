...
const Footer = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="flex flex-wrap sm:gap-4 md:gap-8">
  <ul className="text-sm flex-1 font-playfair mb-4 sm:mb-0 sm:mr-4">
  ...
  <ul className="text-sm flex-1 font-playfair sm:ml-4">
    ...
    <li><Link to="/" className="text-secondary hover:underline">Singing</Link></li>
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="relative w-full h-48 mt-4 rounded-lg overflow-hidden sm:w-1/5">
