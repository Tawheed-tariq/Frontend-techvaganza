...
const Footer = () => {
  return (
    <footer className="bg-primary bg-opacity-20 text-white py-6 font-averia fixed bottom-0 left-0 w-full z-10 overflow-x-hidden">
      <div className="container mx-auto px-2 sm:px-4">
        ...
        <div className="border-t border-secondary my-4 sm:my-6"></div>
