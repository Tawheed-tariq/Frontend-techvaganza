...
const Footer = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="text-2xl font-playfair text-secondary font-extrabold mb-6 sm:text-base md:text-sm lg:text-xs">Where Innovation Meets <br/>Sustainability</p>
          </div>
  ...
  <div className="flex flex-wrap sm:justify-start md:justify-between sm:gap-2 md:gap-8">
    <ul className="text-sm flex-1 font-playfair mb-4 sm:mb-0">
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Hackathons</Link></li>
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Project Showcase</Link></li>
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Workshops</Link></li>
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Tech Talks</Link></li>
      <li><Link to="/" className="text-secondary hover:underline">Trivia</Link></li>
    </ul>
    <ul className="text-sm flex-1 font-playfair sm:ml-2">
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Gaming Arena</Link></li>
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Dancing</Link></li>
      <li className="mb-4"><Link to="/" className="text-secondary hover:underline">Karaoke</Link></li>
      <li><Link to="/" className="text-secondary hover:underline">Singing</Link></li>
          ...
          <div className="w-1/4 md:w-1/3 mb-6 md:mb-0 sm:w-1/3">
