  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-4 pl-5 py-4 md:py-0 bg-gray-100">
      ...
      <div className="mt-2 lg:mt-0 space-x-2 py-2 md:py-6 md:px-5 flex">
        <button className="px-4 md:px-8 py-1 ShadowBlur text-sm md:text-base rounded font-medium text-white bg-primary hover:bg-[#f0ecdf] hover:text-black border border-primary focus:outline-none text-center">
          <Link to={exploreUrl}>
            EXPLORE
          </Link>
        </button>
