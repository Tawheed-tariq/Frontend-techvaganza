        ...
        <div id='timerContainer' className='timer-container mt-6 md:mt-10 flex justify-center'>
          <div className='w-full min-w-[150px] mb-7 px-4 md:px-4 lg:px-40 flex flex-wrap justify-between text-white font-bold overflow-hidden'>
            ...
            <div id='hoursTimer' className='timer-item text-center'>
              <div className='block text-6xl md:text-9xl font-semibold leading-none overflow-hidden'>{timeLeft.hours}</div>
              <div className='timer-label block text-xl md:text-3xl font-light overflow-hidden'>HOURS</div>
            </div>
            <div id='minutesTimer' className='timer-item text-center'>
              <div className='block text-6xl md:text-9xl font-semibold leading-none overflow-hidden'>{timeLeft.minutes}</div>
              <div className='timer-label block text-xl md:text-3xl font-light overflow-hidden'>MINUTES</div>
            </div>
            <div id='secondsTimer' className='timer-item text-center'>
              <div className='block text-6xl md:text-9xl font-semibold leading-none overflow-hidden'>{timeLeft.seconds}</div>
              <div className='timer-label block text-xl md:text-3xl font-light overflow-hidden'>SECONDS</div>
            </div>
          </div>
        </div>
